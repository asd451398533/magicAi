...
MTCNN::MTCNN(const string &model_path) {
	...
	std::vector<std::string> param_files = {
		model_path+"/models/det1.param",
		model_path+"/models/det2.param",
		model_path+"/models/det3.param"
	};

	std::vector<std::string> bin_files = {
		model_path+"/models/det1.bin",
		model_path+"/models/det2.bin",
		model_path+"/models/det3.bin"
	};
