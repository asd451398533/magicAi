...
- (void)commonSetBuity:(float)progress :(NSString *)what{
    ...
    if([what isEqualToString:@"rz"]){
        [self setParamsPrivate:BETypeBeautyReshapeEyeMove :[self.itemArray[14] floatValue]*progress];
    }else if([what isEqualToString:@"eye"]){
        [self setParamsPrivate:BETypeBeautyReshapeEye :[self.itemArray[3] floatValue]*progress];
    }else if([what isEqualToString:@"nose"]){
        [self setParamsPrivate:BETypeBeautyReshapeNoseLean :[self.itemArray[7] floatValue]*progress];
    }
    else if([what isEqualToString:@"lip"]){
        [self setParamsPrivate:BETypeBeautyReshapeMouthZoom :[self.itemArray[11] floatValue]*progress];
    }
    else if([what isEqualToString:@"xb"]){
        [self setParamsPrivate:BETypeBeautyReshapeChin :[self.itemArray[9] floatValue]*progress];
    }
    else if([what isEqualToString:@"face"]){
        [self setParamsPrivate:BETypeBeautyReshapeFaceOverall :[self.itemArray[0] floatValue]*progress];
    }
}
