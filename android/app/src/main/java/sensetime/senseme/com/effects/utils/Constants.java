...
public class Constants {
    public static final int[] beautyTypes = {
            ...
            STBeautyParamsType.ST_BEAUTIFY_ROUND_EYE_RATIO
    };
    ...
    public final static int ST_BEAUTIFY_ROUND_EYE_RATIO = 26;
    ...
    public static final int ST_MAKEUP_EYEBALL = STMobileType.ST_MAKEUP_TYPE_EYEBALL;
