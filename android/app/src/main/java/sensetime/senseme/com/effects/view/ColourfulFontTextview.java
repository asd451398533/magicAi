 ...
 */
public class ColourfulFontTextview extends android.support.v7.widget.AppCompatTextView {
        ...
        if (TextViewWidth == 0) {
            ...
            if (TextViewWidth > 0) {
                ...
                mLinearGradient = new LinearGradient(0, 0, TextViewWidth, 0,
                        new int[]{Color.CYAN, Color.YELLOW, Color.RED, Color.GREEN, Color.GRAY}, null, Shader.TileMode.CLAMP);
                //把渲染器给笔套上
