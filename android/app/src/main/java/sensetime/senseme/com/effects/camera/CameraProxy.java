...
//		parameters.setPreviewSize(640, 480);
        Point pictureSize = getSuitablePictureSize(new Point(previewSize.x,previewSize.y));
        parameters.setPictureSize(pictureSize.x, pictureSize.y);
        Log.e("lsy", "previewSize    " + previewSize.x + "   " + previewSize.y + "  "
...
//		mCamera.setFaceDetectionListener(new MyFaceDetectionListener());
    ...
    private Point getSuitablePictureSize(Point point) {
