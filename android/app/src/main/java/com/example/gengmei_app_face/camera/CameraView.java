...
public class CameraView extends FrameLayout {
    ...
    public void setCall(CameraCallBack c) {
        mImpl.setCall(c);
    }
     ...
     * {@link Callback#onPictureTaken(CameraView, byte[], Camera)}.
     */
    ...
    private class CallbackBridge implements CameraViewImpl.Callback {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            for (Callback callback : mCallbacks) {
                callback.onPictureTaken(CameraView.this, data, camera);
            }
        }
    ...
    public abstract static class Callback {
         ...
         * @param camera
         */
        public void onPictureTaken(CameraView cameraView, byte[] data, Camera camera) {
        }
    }
